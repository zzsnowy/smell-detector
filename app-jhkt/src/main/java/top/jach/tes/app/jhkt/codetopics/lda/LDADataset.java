package top.jach.tes.app.jhkt.codetopics.lda;
...
public class LDADataset {
    ...
    public WordBag[] docs;        // a list of documents
     ...
     */
    public void setDoc(WordBag doc, int idx) {
        if (0 <= idx && idx < M) {
            docs[idx] = doc;
        }
    }
    ...
    public void setDoc(String str, int idx) {
        if (0 <= idx && idx < M) {
            ...
            WordBag doc = new WordBag(ids, str);
            docs[idx] = doc;
