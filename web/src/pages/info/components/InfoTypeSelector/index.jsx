...
@connect(({ infos, loading }) => ({
  infoTypes: infos.infoTypes,
  loading: loading.effects['infos/fetchInfoTypes'],
}))
class InfoTypeSelector extends Component {
  state = {
...
export default Form.create()(InfoTypeSelector);
